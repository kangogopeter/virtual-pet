...
public DatabaseRule database = new DatabaseRule();
    ...
    public void person_instantiatesCorrectly_true() {
        Person testPerson = new Person("Henry", "[https://peterkangogo501@gmail.com]");
    ...
    public void getEmail_personInstantiatesWithEmail_String() {
        Person testPerson = new Person("Henry", "[https://peterkangogo501@gmail.com]");
        assertEquals("[https://peterkangogo501@gmail.com]", testPerson.getEmail());
    }
    @Test
    public void equals_returnsTrueIfNameAndEmailAreSame_true() {
        Person firstPerson = new Person("Henry", "[https://peterkangogo501@gmail.com]");
        Person anotherPerson = new Person("Henry", "[https://peterkangogo501@gmail.com]");
        assertTrue(firstPerson.equals(anotherPerson));
    }
    @Test
    public void save_insertsObjectIntoDatabase_Person() {
        Person testPerson = new Person("Henry", "[peterkangogo501@gmail.com]");
        testPerson.save();
